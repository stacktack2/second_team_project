				...
				<div class="container-fluid px-4">
					...
					<div class="card mb-4">
						<div class="card-header">
							수강과목 
							<a href="acdCourse/subcheck.do" class="nav-link right bold">&#43;</a>
						</div>
						<div class="card-body">
							<table class="datatable-table">
								...
								<tbody>
									<tr>
										<td>1</td>
										<td><a href="acdCourse/curriculum.do">물리화학</a></td>
										<td>윤도연</td>
										<td>월 2교시</td>
										<td>상 101</td>
									</tr>
					...
					<div class="card mb-4">
						<div class="card-header">
							공지사항 <a href="notice/noticeList.do" class="nav-link right bold">&#43;
							</a>
						</div>
						<div class="card-body">
							<table class="datatable-table">
