									...
									<table class="datatable-table viewtable sschecktable">
										<tbody>
											...
											<tr>
												...
												<td colspan="5">
													ㅇㅇㅇ를 정의하고, 이들의 구조 및 성질을 이해하고, ㅇㅇㅇ의 성질등을 파악하여 ㅇㅇㅇ의 현황, 응용실태 및 향후 연구개발 방향을 논의한다. 
													수강 후 ㅇㅇㅇ의 이해를 통하여 ㅇㅇㅇ업계의 취업시 업무 추진 능력을 배양하고, 진학 및 연속 연구 수행시 ㅇㅇㅇ에 관련된 학문을 깊이있게 추진할 수 있는 소양을 닦는다.
												</td>
											</tr>
										</tbody>
									</table>
