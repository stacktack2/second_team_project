...
-->
                            	...
                            	<p> - 휴학기간을 연장하고자 할 때에는 휴학기간 만료 7일전까지 휴학 연장원을 제출하여 총장의 허가를 받아야 함.</p>
                            	<p>* 신(편)입생의 휴학</p>
                            	<p> - 신(편)입생에게는 입학이후 1년간 휴학을 허가하지 아니한다. 다만, 법령에 의한 의무이행, 임신.출산.육아, 질병, 대학원생, 기타 부득이한 사유로 인하여 수학할 수 없는 경우는 예외로 한다.</p>
                            	<p>* 복학</p>
                            	<p> - 복학은 매 학기 등록기간 내에 소정의 복학신청서를 제출해야 하며, 수업일수 1/3이상 경과 되었을 때에는 복학을 허가하지 아니함.</p>
                            	<p> - 군입대 후 전역예정자인 경우, 수업일수 2/3이상 출석이 가능함을 입증하는 서류(휴가증, 전역예정 증명서, 부대장의 복학추천서 등)를 첨부하여 제출하면 복학을 허가함.</p>
