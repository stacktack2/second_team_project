			...
			<main>
				<div class="container-fluid px-4">
					...
					<div class="card mb-4 white">
						...
						<input type="file" name="profPhoto" id="photoInput" onchange="displayPhotoPreview(event)" 
								value="<%=request.getContextPath()%>/upload/profUpload/${professorVO.foriginnm}" style="display: none;">
									...
									<tr>
										...
										<td style="width: 20rem;">
											<input type="text" name="pid" id="pid" oninput="checkId(this)" 
													...
													class="datatable-input" value="${professorVO.pid }" required>
										</td>
										<th>성명</th>
										<td style="width: 20rem;">
