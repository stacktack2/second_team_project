		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">수강신청 준비 강의 추가</h1>
					<ol class="breadcrumb mb-4">
						<li class="breadcrumb-item">강의 관리</li>
						<li class="breadcrumb-item active">수강신청 열기/닫기</li>
					</ol>

					<div class="card mb-4 white">
						<div class="card-header disNone">수강신청 준비 강의 추가</div>
						<div class="card-body">
							<div
							...
							<div class="datatable-bottom">
								<div class="datatable-bottom d-inline-block">
									<a href="courseRegList.do" class="btn btn-primary grey right mright">완료</a>
								</div>
							</div>
						</div>
					</div>
