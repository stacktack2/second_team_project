		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid px-4">
					<h1 class="mt-4">수강신청 준비 강의 관리</h1>
					...
					<div class="card mb-4 white">
						<div class="card-header disNone">수강신청 준비 강의 관리</div>
						<div class="card-body">
							<div
							...
							<button class="btn btn-primary inline grey" type="button">수강신청 닫기</button>
						</div>
					</div>
