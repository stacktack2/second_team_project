...
public class ProfessorVO {
	...
	private String pfrealnm;
	private String pforiginnm;
	
	public String getPfrealnm() {
		return pfrealnm;
	}
	public void setPfrealnm(String pfrealnm) {
		this.pfrealnm = pfrealnm;
	}
	public String getPforiginnm() {
		return pforiginnm;
	}
	public void setPforiginnm(String pforiginnm) {
		this.pforiginnm = pforiginnm;
	}
	public int getPno() {
		return pno;
	}
	...
	public String getPuniv() {
		return puniv;
	}
	public void setPuniv(String puniv) {
		this.puniv = puniv;
	}
	...
	public String getPappointDate() {
		return pappointDate;
	}
	public void setPappointDate(String pappointDate) {
		this.pappointDate = pappointDate;
	}
	public int getPdelyn() {
		return pdelyn;
	}
