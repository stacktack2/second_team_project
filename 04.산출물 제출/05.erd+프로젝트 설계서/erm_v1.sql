...
(
	abseno int unsigned NOT NULL AUTO_INCREMENT COMMENT '휴복학번호',
	abseinfo tinyint unsigned NOT NULL COMMENT '신청종류',
	abserdate date NOT NULL COMMENT '신청일자',
	absestatus tinyint unsigned COMMENT '처리상태',
	absepdate date COMMENT '처리일자',
	absereason text COMMENT '승인사유',
	abseyn tinyint unsigned COMMENT '승인여부',
